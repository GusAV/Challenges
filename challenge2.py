'''
Create a class to convert from decimal numbers to location numerals and back.
This class should have 3 methods:
...
One method that takes a location numeral and returns its value as an integer.
That is, you pass ad in, and it returns 9
One method that takes a location numeral and returns it in abbreviated form.
